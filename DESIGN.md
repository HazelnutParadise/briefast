...
- **大盤走勢預測（market-outlook）**：置於盤前總覽主欄頭條下，標示 12.5px、方向襯線 24px、「預期走法」襯線 16.5px、「判斷依據」襯線 15px；有可靠三階段情境時，在方向後顯示定性 SVG 折線與開盤、盤中、尾盤相對前收的位置，標明「情境示意・相對前收，非點位或漲跌幅」，再呈現走法及理由。線條用中性文字色，收盤點偏多紅、偏空綠、震盪中性。與總覽內文以留白分隔，不加卡片或裝飾規線。舊報告缺圖或走勢文字時只省略對應部分，缺整個預測時整段省略。
