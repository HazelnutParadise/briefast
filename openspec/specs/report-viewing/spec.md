...
- **THEN** the overview displays its original headline and body first, followed by `今日大盤走勢預測`, `偏多`, a three-point qualitative diagram with phase and level labels and a non-point caveat, `預期走法`, the trajectory, and the explanation in that order
